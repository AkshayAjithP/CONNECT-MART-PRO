                                ...
                                <div class="page-wrapper">
                                    <div class="page-body">
                                      <div class="row">
                                            ...
                                            <?php
												  	$result = $db->prepare("SELECT * FROM product where branch='$bname'");
													$result->execute();
                                                ...
                                                <div class="card user-card">
                                                  ...
                                                  <div class="card-block">
                                                   <img src="../product_ph/<?php echo $rows['photo'];?>" alt="img" class="img-fluid" width="100%">
                                                    ...
                                                    <hr/>
                                                    <a href="action/product_damage.php<?php echo '?prd_id='.$prd_id; ?>" class="btn btn-primary btn-out-dashed btn-block">Damage</a>
                                                     <hr/>                                                      
                                                    </div>
