                                ...
                                <div class="page-wrapper">
                                    <div class="page-body">
                                      <div class="row">
                                            ...
                                            <?php
												$result = $db->prepare("SELECT * FROM offers where location='$location'");
												$result->execute();
                                            ...
                                            <div class="col-md-4">
                                                <div class="card user-card">
                                                    ...
                                                    <h5>Offers <?php echo $rows['name'];?></h5>
                                                    </div>
                                                  ...
                                                  <div class="card-block">
                                                   ...
                                                   <table class="table table-bordered">
                                                    ...
                                                    <tr>
                                                     ...
                                                     <hr>
                                                   		<a href="offers_location.php" class="btn btn-info btn-out-dashed btn-block">Back</a>
                                                     <hr/>                                                      
                                                    </div>
