                                            ...
                                            <!-- Basic Form Inputs card start -->
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5 class="m-b-10">Offers Search</h5>
                                                     </div>
                                                     <div class="card-block">
                                					<form method="post" action="offers_search_view.php" autocomplete="off"> 
                                                 				...
                                                 				<input list="name" required class="form-control form-control-primary" name="name" placeholder="Search Name">
                                                                    <datalist id="name">
                                                                        <option value="">Select</option> 
                                                                         <?php
                                                                           $result = $db->prepare("select distinct name from offers where bname='$bname'");
                                                                            $result->execute();
