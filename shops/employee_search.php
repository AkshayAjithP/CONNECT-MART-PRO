                                            ...
                                            <!-- Basic Form Inputs card start -->
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5 class="m-b-10">Employee Search</h5>
                                                     </div>
                                                     <div class="card-block">
                                					<form method="post" action="employee_searchv.php" autocomplete="off"> 
                                                 				...
                                                 				<input list="name" required class="form-control form-control-primary" name="name" placeholder="Search Name">
                                                                    <datalist id="name">
                                                                        <option value="">Select</option> 
                                                                         <?php
                                                                           $result = $db->prepare("select * from user where utype='Employee' and liceno='$name'");
                                                                            $result->execute();
