        ...
        <ul class="pcoded-item pcoded-left-item">
            ...
            <li class="pcoded-hasmenu">
             ...
             <li class="pcoded-hasmenu">
                <a href="javascript:void(0)">
                    <span class="pcoded-micon"><i class="ti-layout-grid2-alt"></i></span>
                    <span class="pcoded-mtext"  data-i18n="nav.basic-components.main">Branch</span>
                    <span class="pcoded-mcaret"></span>
                </a>
                <ul class="pcoded-submenu">                    
                    <li class=" ">
                        <a href="branch_register.php">
                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
            ...
            <li class="pcoded-hasmenu">
                ...
                <ul class="pcoded-submenu">
                    ...
                    <li class=" ">
                        <a href="employee_permission.php">
                            <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                            <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Permission</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                    </li> 
                </ul>
