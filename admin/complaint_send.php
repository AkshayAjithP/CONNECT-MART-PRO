<?php
	...
	$result = $db->prepare("select * from complaint where fdbk_id='$fdbk_id'");
	$result->execute();
                                            ...
                                            <!-- Basic Form Inputs card start -->
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5 class="m-b-10">Complaint Reply</h5>
                                                        
                                                     </div>
                                                     <div class="card-block">
                                                        <form method="post" enctype="multipart/form-data" autocomplete="off" action="action/complaints_view_send_save.php">
