<?php
	...
	$bk_id=$_GET['bk_id'];
	$result = $db->prepare("SELECT * FROM bpackage where bk_id='$bk_id'");
	$result->execute();
                                            ...
                                            <!-- Basic Form Inputs card start -->
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5 class="m-b-10">Package Update</h5>
                                                        
                                                     </div>
                                                     <div class="card-block">
                                                       <form method="post" action="action/package_update.php" enctype="multipart/form-data" autocomplete="off">
